<template>
  <div class="p-6 flex gap-4 lg:gap-8 bg-surface-0 dark:bg-surface-950">
      <div id="app-sidebar-floating-slim" class="w-24 lg:block hidden p-6 bg-surface-100 dark:bg-surface-800 rounded-2xl">
          <div class="h-full w-full flex flex-col">
              <div class="flex-1 flex flex-col items-center overflow-auto">
                  <svg class="fill-surface-900 dark:fill-surface-0" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="w-full h-px bg-surface-200 dark:bg-surface-700 my-6" />
              ...
              <div class="flex flex-col items-center">
                  ...
                  <div class="w-full h-px bg-surface-200 dark:bg-surface-700 my-6" />
                  <Avatar image="https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/avatars/circle/avatar-m-18.jpg" class="!w-10 !h-10 cursor-pointer" shape="circle" />
              </div>
          </div>
      </div>
